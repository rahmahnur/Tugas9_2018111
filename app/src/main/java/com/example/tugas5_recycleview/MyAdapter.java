...
public class MyAdapter extends
    ...
    Context context;
    int singledata;
    ArrayList<com.example.tugas5_recycleview.Model>modelArrayList;
    SQLiteDatabase sqLiteDatabase;
    //generate constructor
    public MyAdapter(Context context, int singledata,
                     ArrayList<com.example.tugas5_recycleview.Model> modelArrayList, SQLiteDatabase sqLiteDatabase) {
    ...
    public void onBindViewHolder(@NonNull MyAdapter.ViewHolder
        ...
        final com.example.tugas5_recycleview.Model model = modelArrayList.get(position);
                    ...
                    public boolean onMenuItemClick(MenuItem item)
                    {
                        switch (item.getItemId()){
                            case R.id.edit_menu:
                                ...
                                //delete operation
                                com.example.tugas5_recycleview.DBmain dBmain = new
                                        com.example.tugas5_recycleview.DBmain(context);
                                sqLiteDatabase =
