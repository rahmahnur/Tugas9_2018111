...
import com.example.tugas5_recycleview.databinding.ActivityMain4Binding;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_alarm) {
                    ...
                    Intent b = new Intent(MainActivity4.this,
                            MainActivity1.class);
                    startActivity(b);
                } else if (id == R.id.nav_chat) {
                    Intent c = new Intent(MainActivity4.this,
                            MainActivity2.class);
                    startActivity(c);
                } else if (id == R.id.nav_profile) {
                    Intent d = new Intent(MainActivity4.this,
                            MainActivity3.class);
                    startActivity(d);
                }
                else if (id == R.id.nav_sql) {
                    Intent e = new Intent(MainActivity4.this,
                            MainActivity4.class);
                    startActivity(e);
                }
                return true;
